...
bot = telebot.TeleBot(data.gemToken)
genai.configure(api_key="AIzaSyD3tWjZOW3qTLO2JL3ykIyB3cBxgSbfc4I")
            ...
            for user in users:
                ...
                try:
                    ...
                    if chat_id not in sent_chat_ids:
                        ...
                        bot.send_message(chat_id, "Бот приостанавливает свою работу на некоторый срок" )
